...
describe("Do checkout", () => {
    ...
    it("should not be able to do a checkout with no items in cart", ()=>{
        ...
        cy.get("input").get("#name").type("Abba");
        cy.get("input").get("#country").type("Sweden");
        cy.get("input").get("#city").type("Stockholm");
        cy.get("input").get("#card").type("4002 8922 4902 8922");
        cy.get("input").get("#month").type("June");
        cy.get("input").get("#year").type("1972");
